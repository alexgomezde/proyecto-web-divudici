...
import { faSearch, faTimes,  faSync, faEraser, faFileInvoiceDollar } from '@fortawesome/free-solid-svg-icons';
            ...
            <Row>
                <Col md="12">
                    <div className="heading mt-4 mb-4">
                        <h2 className="d-inline mt-4" >Facturas</h2>
                ...
                <Col md="3">
                    ...
                    <FontAwesomeIcon icon={faFileInvoiceDollar} size="9x" className="text-white mt-5"/>
                    </div>
                </Col>
                <Col md="9">
                    <div className="content">
                        ...
                        <div className="table-wrapper">
                            ...
                            <FacturaData inputSearchTerm={inputSearchTerm} selectedTypeSearch={selectedTypeSearch} />
