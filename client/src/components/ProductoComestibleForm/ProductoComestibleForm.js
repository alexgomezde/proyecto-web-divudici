...
const ProductoComestibleForm = ({currentId, setCurrenteId, isOpen, setshow, currentConsecutivo, setCurrentConsecutivo, selectedConsecutivo}) => {
    ...
    useEffect(() => { if(selectedConsecutivo){setComestibleData({ ...comestibleData, id_consecutivo : selectedConsecutivo._id, codigo : selectedConsecutivo.prefijo + selectedConsecutivo.valor})} }, [selectedConsecutivo]);
                    ...
                    <Row>
                        <Col md="6">
                            <Row>
                                ...
                                <Col>
                                    <FormGroup>
                                        <FormControl type="text" disabled name="codigo" value={comestibleData.codigo}></FormControl>
                                    </FormGroup>
                                </Col>
                            </Row>
                            <Row>
