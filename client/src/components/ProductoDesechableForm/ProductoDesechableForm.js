...
const ProductoDesechableForm = ({currentId, setCurrenteId, isOpen, setshow, currentConsecutivo, setCurrentConsecutivo, selectedConsecutivo}) => {
    ...
    useEffect(() => { if(selectedConsecutivo){setDesechableData({ ...desechableData, id_consecutivo : selectedConsecutivo._id, codigo : selectedConsecutivo.prefijo + selectedConsecutivo.valor})} }, [selectedConsecutivo]);
            ...
            <Modal.Body className="mbody">
                <Form autoComplete="off" noValidate onSubmit={handleSubmit} id="consecutivo-form"> 
                    <Row>
                        ...
                        <Col>
                            <FormGroup>
                                <FormControl type="text" disabled name="codigo" value={desechableData.codigo}></FormControl>
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row>
